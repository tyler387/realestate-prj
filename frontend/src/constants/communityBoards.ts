...
export const DEFAULT_SORT_TYPE: SortType = 'LATEST'
...
export const apartmentBoards: Array<{ value: BoardCode; label: string }> = [
  ...
  { value: 'APT_TRADE', label: '거래' },
  { value: 'APT_ISSUE', label: '민원/하자' },
]

export const communitySortTypes: SortType[] = ['LATEST', 'POPULAR', 'COMMENT']
...
export const isSortType = (value: string | null): value is SortType =>
  communitySortTypes.some((sortType) => sortType === value)
...
export const sortTypeLabelOf = (sortType: SortType) => sortTypeLabels[sortType]
